...
class StreamPlatformTestCase(APITestCase):
    ...
    def test_streamplatform_ind(self):
        # here 'args' is tuple
        response = self.client.get(reverse('streamplatform-detail',
                                           args=(self.stream.id,)))
...
class watchListTestCase(APITestCase):
    ...
    def test_watchlist_ind(self):
        # here 'args' is tuple
        response = self.client.get(reverse('movie-detail', 
                                           args=(self.watchlist.id,)))
        self.assertEqual(response.status_code, status.HTTP_200_OK)
...
class ReviewTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.review = models.Review.objects.create(review_user=self.user,
                                                   rating=5, description="Good Movie!!!", watchlist=self.watchlist2, active=True)  
    ...
    def test_review_update(self):
        ...
        response = self.client.put(reverse('review-detail', 
                                            args=(self.review.id,)), data)
        # self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_reveiw_ind(self):
        response = self.client.get(reverse('review-detail', 
                                           args=(self.review.id,)))
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        

    def test_review_delete(self):
        response = self.client.delete(reverse('review-detail',
                                              args=(self.review.id,)))
